...
export class PatientsTableComponent implements OnInit {
  ...
  displayedColumns: Array<string> = [' תאריך-איינטיק ', ' קופ"ח ', ' עיר ', ' כתובת ', ' טלפון- 2 ', ' טלפון- 1 ', ' מוסד ', ' מין ', 'שם-משפחה', ' שם-פרטי ', ' תאריך-לידה ', ' תעודת-זהות '];
  ...
  initTable() {
    //מפונקציה 
    //GetAllPatientByStatus
    //מתקבלים תלמידים בעלי סטטוס התקבל ולכן נשלח לפונקציה 4
